...
const TestimonialSection: React.FC = () => {
  ...
  const visibleTestimonials = (testimonials as Testimonial[])
    .filter((t) => t.visible)
    .slice()
    ...
    <section id="testimonials" className="border-b-4 border-black overflow-hidden">
      ...
      <div className="flex flex-col">
        {visibleTestimonials.map((t, idx) => (
          <div key={t._id} className={`flex flex-col lg:flex-row divide-y-4 lg:divide-y-0 lg:divide-x-4 divide-black ${idx !== visibleTestimonials.length - 1 ? 'border-b-4 border-black' : ''}`}>
            ...
            <div className="lg:w-1/3 p-12 lg:p-24 bg-[#FF5F1F] text-white flex flex-col justify-end">
               <div className="space-y-4">
                  ...
                  <h4 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold uppercase leading-none break-words">{t.author}</h4>
